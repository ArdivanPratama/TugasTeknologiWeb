        ...
        <div class="w-full container mx-auto flex flex-wrap items-center mt-0 pt-3 pb-3 md:pb-0">
            ...
            <div class="w-1/2 pl-2 md:pl-0">
                <a class="text-gray-100 text-base xl:text-xl no-underline hover:no-underline font-bold" href="#">
                    <i class="fas fa-moon text-blue-400 pr-3">BUTIK SENTOSA</i>
                </a>
            </div>
                ...
                <div class="flex relative inline-block float-right">
                    ...
                    <div class="relative text-sm text-gray-100">
                        <button id="userButton" class="flex items-center focus:outline-none mr-3">
                            <img class="w-8 h-8 rounded-full mr-4" src="https://www.pngkey.com/png/full/353-3534482_avatar-portfolio-02-avatar-sketch-cartoon-avatar.png" alt="Avatar of User"> <span class="hidden md:inline-block text-gray-100">Hi, {{ Auth::user()->name }}</span>
                            ...
                            <ul class="list-reset">
                                ...
                                <li>
                                    <form action="{{ route('logout') }}" method="POST">
                                        @csrf
                                        <button type="submit" class="px-4 py-2 block text-gray-100 hover:bg-gray-800 no-underline hover:no-underline">Logout</button>
                                    </form>
                                </li>
                            </ul>
                        </div>
                ...
                <ul class="list-reset lg:flex flex-1 items-center px-4 md:px-0">
                    ...
                    <li class="mr-6 my-2 md:my-0">
                        <a href="#" class="block py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-gray-100 border-b-2 border-gray-900  hover:border-pink-400">
                            <i class="fas fa-tasks fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">Stocks</span>
                        </a>
                    </li>
                    <li class="mr-6 my-2 md:my-0">
                    ...
                    <div class="bg-gray-900 border border-gray-800 rounded shadow p-2">
                        <div class="flex flex-row items-center">
                            ...
                            <div class="flex-1 text-right md:text-center">
                                <h5 class="font-bold uppercase text-gray-400">Total Penghasilan</h5>
                                <h3 class="font-bold text-3xl text-gray-600">Rp. 57.300.000,00 <span class="text-green-500"><i class="fas fa-caret-up"></i></span></h3>
                            </div>
                        </div>
                    </div>
                    <!--/Metric Card-->
                ...
                <div class="w-full md:w-1/2 xl:w-1/3 p-3">
                    ...
                    <div class="bg-gray-900 border border-gray-800 rounded shadow p-2">
                        <div class="flex flex-row items-center">
                            ...
                            <div class="flex-1 text-right md:text-center">
                                <h5 class="font-bold uppercase text-gray-400">Total Pengunjung</h5>
                ...
                <div class="w-full md:w-1/2 xl:w-1/3 p-3">
                    ...
                    <div class="bg-gray-900 border border-gray-800 rounded shadow p-2">
                        <div class="flex flex-row items-center">
                            ...
                            <div class="flex-1 text-right md:text-center">
                                <h5 class="font-bold uppercase text-gray-400">Pengunjung Baru</h5>
                                <h3 class="font-bold text-3xl text-gray-600">5 <span class="text-yellow-600"><i class="fas fa-caret-up"></i></span></h3>
                            </div>
                        </div>
                    </div>
                    <!--/Metric Card-->
                ...
                <div class="w-full md:w-1/2 xl:w-1/3 p-3">
                    ...
                    <div class="bg-gray-900 border border-gray-800 rounded shadow p-2">
                        <div class="flex flex-row items-center">
                            ...
                            <div class="flex-1 text-right md:text-center">
                                <h5 class="font-bold uppercase text-gray-400">Waktu Aktif Server</h5>
                                <h3 class="font-bold text-3xl text-gray-600">79 days</h3>
                            </div>
                        </div>
                    </div>
                    <!--/Metric Card-->
                ...
                <div class="w-full md:w-1/2 xl:w-1/3 p-3">
                    ...
                    <div class="bg-gray-900 border border-gray-800 rounded shadow p-2">
                        <div class="flex flex-row items-center">
                            ...
                            <div class="flex-1 text-right md:text-center">
                                <h5 class="font-bold uppercase text-gray-400">Pesanan</h5>
                                <h3 class="font-bold text-3xl text-gray-600">7 Pesanan Baru</h3>
                            </div>
                        </div>
                    </div>
                    <!--/Metric Card-->
                ...
                <div class="w-full md:w-1/2 xl:w-1/3 p-3">
                    ...
                    <div class="bg-gray-900 border border-gray-800 rounded shadow p-2">
                        <div class="flex flex-row items-center">
                            ...
                            <div class="flex-1 text-right md:text-center">
                                <h5 class="font-bold uppercase text-gray-400">Feedback</h5>
                    ...
                    <div class="bg-gray-900 border border-gray-800 rounded shadow">
                        ...
                        <div class="p-5">
                            <table class="w-full p-5 text-gray-700">
                                <thead>
                                    <tr>
                                        <th class="text-left text-gray-600">Barang</th>
                                        <th class="text-left text-gray-600">Harga</th>
                                        <th class="text-left text-gray-600">Stock</th>
                                    </tr>
                                </thead>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Dress Pengantin</td>
                                        <td>Rp. 600.000,00</td>
                                        <td>Habis</td>
                                    </tr>
                                    <tr>
                                        <td>Kebaya Pengantin</td>
                                        <td>Rp. 450.000,00</td>
                                        <td>Habis</td>
                                    </tr>
                                </tbody>
                            ...
                            <p class="py-2"><a href="#" class="text-white">Liat barang lainnya...</a></p>
                ...
                <div class="flex w-full md:w-1/2 ">
                    <div class="px-8">
                        ...
                        <p class="py-4 text-gray-600 text-sm">
                            we provide the best clothing and accessories products, not giving products that are not quality for the sake of just looking for money
                        </p>
                    </div>
                </div>
